...
namespace DTT.BubbleShooter.Demo
{
    ...
    public class TurretNavigator : MonoBehaviour
    {
        ...
        [SerializeField]
        private GameObject _cancleShotObject;
        ...
        private void HandleHover(Vector2 position)
        {
            ...
            Vector3 smoothDirection = Vector3.Lerp(transform.up, mouseDirection, Time.deltaTime * _smoothFactor);
            transform.up = smoothDirection;
            _cancleShotObject.SetActive(true);
        }
