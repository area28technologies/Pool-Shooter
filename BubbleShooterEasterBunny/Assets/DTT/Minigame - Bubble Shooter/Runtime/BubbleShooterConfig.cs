...
namespace DTT.BubbleShooter
{
    ...
    public class BubbleShooterConfig : ScriptableObject
    {
        ...
        private int[] _missedShotsTillNewRow;
        ...
        [SerializeField]
        [Tooltip("The amount of shot the turret has to shot until a new row appears")]
        private int[] _timeWithNoNewShot;

        /// <summary>
        /// <inheritdoc cref="_timeWithNoNewShot"/>
        /// </summary>
        public int[] TimeWithNoNewShot => _timeWithNoNewShot;
        ...
        /// <summary>
        /// <inheritdoc cref="_timeToChange"/>
        /// </summary>
        public int[] TimeToChange => _timeToChange;
