...
namespace DTT.BubbleShooter
{
    ...
    public class Turret
    {
        ...
        /// </summary>
        public event Action<List<Bubble>, bool> Reloaded;

        public event Action<List<Bubble>, bool> Swaped;
        ...
        public void Reload(List<Bubble> bubble)
        {
            _bubble = bubble[0];
            Reloaded?.Invoke(bubble, false);
        }

        public void Swap(List<Bubble> bubble, bool isSwap)
        {
            if (isSwaping) { return; }

            _bubble = bubble[0];
            Swaped?.Invoke(bubble, isSwap);
        }

        public void SetSwaping(bool isSwaping)
        {
